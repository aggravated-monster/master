...
from mario_stable_baselines_phase1.experiments.agents import PositionEnabledAgent, VanillaAgent
...
position_enabled_agent = PositionEnabledAgent(config, env, device, TENSORBOARD_LOG_DIR, CHECKPOINT_FREQUENCY, CHECKPOINT_DIR )
position_enabled_agent.execute(5, 100)

vanilla_agent = VanillaAgent(config, env, device, TENSORBOARD_LOG_DIR, CHECKPOINT_FREQUENCY, CHECKPOINT_DIR )
