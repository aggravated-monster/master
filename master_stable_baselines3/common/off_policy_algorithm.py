...
from master_stable_baselines3.common.base_class import BaseAlgorithm
from master_stable_baselines3.common.buffers import DictReplayBuffer, ReplayBuffer
from master_stable_baselines3.common.callbacks import BaseCallback
from master_stable_baselines3.common.noise import ActionNoise, VectorizedActionNoise
from master_stable_baselines3.common.policies import BasePolicy
from master_stable_baselines3.common.save_util import load_from_pkl, save_to_pkl
from master_stable_baselines3.common.type_aliases import GymEnv, MaybeCallback, RolloutReturn, Schedule, TrainFreq, TrainFrequencyUnit
from master_stable_baselines3.common.utils import safe_mean, should_collect_more_steps
from master_stable_baselines3.common.vec_env import VecEnv
from master_stable_baselines3.her.her_replay_buffer import HerReplayBuffer
...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def _sample_action(
        ...
        if self.num_timesteps < learning_starts and not (self.use_sde and self.use_sde_at_warmup):
            # Warmup phase
            # This phase uses no prediction at all.
            # TODO: figure out if the bizarre sprinting phenomenon originates here.
            # or else reduce the learning_starts parameter
            ...
            # TODO: eiher advise here or inside the predict method
