...
function install_binary {
  ...
  if [[ ! -d "${binary_folder}" ]]; then
    echo "Extracting ${binary_tar_file}..."#!/usr/bin/env bash
...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
  ilasp_url="https://github.com/ilaspltd/ILASP-releases/releases/download/v4.4.0/ILASP-4.4.0-ubuntu.tar.gz"
  clingo_url="https://github.com/potassco/clingo/releases/download/v5.6.0/clingo-5.6.0-linux-x86_64.tar.gz"
elif [[ "$OSTYPE" == "darwin"* ]]; then
  ilasp_url="https://github.com/marklaw/ILASP-releases/releases/download/v4.4.0/ILASP-4.4.0-OSX.tar.gz"
  clingo_url="https://github.com/potassco/clingo/releases/download/v5.6.0/clingo-5.6.0-macos-x86_64.tar.gz"
else
...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
  ilasp_url="https://github.com/marklaw/ILASP-releases/releases/download/v4.4.0/ILASP-4.4.0-ubuntu.tar.gz"
