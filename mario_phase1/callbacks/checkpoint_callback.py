...
class CheckpointCallback(BaseCallback, ABC):
    ...
    def _init_callback(self):
        if self.save_path is not None:
            ...
            with open(self.save_path + "/" + self.model.name + "_configuration.json", "w") as outfile:
    ...
    #def _on_training_end(self) -> None:
        ...
        #plt.plot(self.total_rewards100000)
        #plt.show()
    ...
    def save_model(self):
        ...
        torch.save(self.model.local_net.state_dict(), self.save_path + self.model.name + "_" + str(self.num_timesteps_done) +
                   "_" + str(self.model.seed) + "_online_net.pt")
        torch.save(self.model.target_net.state_dict(), self.save_path + self.model.name + "_" + str(self.num_timesteps_done) +
