...
def initialize(for_experiments: bool = False, name: str = ''):
    ...
    if for_experiments:
        partial_interpretations_dir = "../../results/symbolic_exp/test1-alt_flush_addition/examples"
        advice_program_dir = "../../results/symbolic_exp/test1-alt_flush_addition/advice"
    else:
